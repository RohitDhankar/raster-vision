...
def get_config(runner) -> SemanticSegmentationConfig:
    ...
    ##path = "/home/dhankar/temp/02_23/raster_vision/raster-vision/output/"#pipeline-config.json"
    output_root_uri = "/home/dhankar/temp/02_23/raster_vision/raster-vision/output/"
